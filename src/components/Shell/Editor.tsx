      ...
      assetsToDisplayUrls(note.body)
        .then((displayBody) => {
          try {
            ...
            // blockquotes, `==highlights==` and math into live blocks on load.
            const inflated = inflateMath(inflateRichFormats(inflateCallouts(inflateWebBlocks(inflateEmbeds(inflateCollectionViews(inflateViewBlocks(blocks)))))), math.spans);
