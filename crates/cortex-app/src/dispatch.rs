...
pub const COMMANDS: &[CommandInfo] = &[
    ...
    CommandInfo { name: "run_view", mode: Mode::Blocking, exposure: Exposure::Both },
    ...
    CommandInfo { name: "run_chart", mode: Mode::Blocking, exposure: Exposure::Both },
    CommandInfo { name: "run_stats", mode: Mode::Blocking, exposure: Exposure::Both },
